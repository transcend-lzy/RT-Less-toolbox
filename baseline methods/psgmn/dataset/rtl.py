...
class Metal_Dataset(Dataset):
    def __init__(self, root, cls, is_train=True, scene=None, index=None):
        ...
        self.render_dir = '/home/wzz/4T/chaoyue/rtl/newRenders'
        self.random_num = 660
        self.random_render_num = 340
        self.scene = scene
        self.index = index
        self.bg_imgs_path = "/home/wzz/4T/chaoyue/rtl/bg_imgs.npy"
        self.sun_path = "/home/wzz/4T/chaoyue/SUN2012pascalformat"
        if is_train:
    ...
    def random_background(self, img, mask):
        '''
        Randomly replace image backgrounds
        :param img:
        :param mask:
        :return:
        '''
    ...
    def __getitem__(self, index):
        ...
        img -= [0.419, 0.427, 0.424]  # train data
