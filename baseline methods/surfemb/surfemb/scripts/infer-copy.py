...
parser.add_argument('--model_path', default= 'data/models/rtl-0.ckpt')
parser.add_argument('--scene_dir_id', default= '7')
...
def test(args):
    ...
    if not osp.exists(pose_dir):
        os.mkdir(pose_dir)
    poses_fp = results_dir / f'{scene_dir_id}/{model_name}-poses.npy'
    poses_scores_fp = results_dir / f'{scene_dir_id}/{model_name}-poses-scores.npy'
    poses_timings_fp = results_dir / f'{scene_dir_id}/{model_name}-poses-timings.npy'
