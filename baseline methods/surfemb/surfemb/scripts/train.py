...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='rtl')
    parser.add_argument('--n-valid', type=int, default=150)
    ...
    parser.add_argument('--synth', default=False)
    parser.add_argument('--real', default=True)
    ...
    if args.real:
        assert args.dataset in {'tless', 'tudl', 'ycbv', 'rtl'}
