...
class ModelAligner(object):
    ...
    translation_transforms = {
         'obj1': np.array([8.63861388e-09, 8.00000076e-02, 4.31923135e-02]),
         'obj3': np.array([ 8.63861388e-09, 8.00000076e-02 ,4.31923135e-02])
    }
    intrinsic_matrix = {
    ...
    def __init__(self, class_type='cat'):
        ...
        self.blender_model_path = os.path.join(cfg.LINEMOD,'cad/{}.ply'.format( class_type))
    ...
    def get_translation_transform(self):
        ...
        return self.translation_transforms['obj1']
...
class PoseTransformer(object):
    ...
    def __init__(self, class_type):
        self.class_type = class_type
        self.blender_model_path = os.path.join(cfg.LINEMOD,'cad/{}.ply'.format(class_type))
        self.orig_model_path = os.path.join(cfg.LINEMOD_ORIG,'{}/obj3.ply'.format(class_type))
